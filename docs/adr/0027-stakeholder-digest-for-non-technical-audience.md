...
**We generate a separate non-technical stakeholder digest distinct from eli5**, because the digest is for PMs and executives (business impact, risk register, budget implications) while eli5 is for developers (analogies, practical consequences). Different audiences need different documents, not the same document written at a lower reading level.
